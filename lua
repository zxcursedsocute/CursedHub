...
elseif Place == tonumber(18687417158) or Place == tonumber(83645629621104) then
...
else loadstring(game:HttpGet("https://raw.githubusercontent.com/zxcursedsocute/CursedHub/refs/heads/main/Main"))()
end
